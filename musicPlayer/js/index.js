$(function(){
    ...
    // setTimeout(function(){
    //     console.log(window.parent.window['test']);
    // }, 1000);
    ...
    var musicUrls = window.parent.window['musicUrls'];
    var artistNameData = window.parent.window['artistNameData'];
    var musicNameData = window.parent.window['musicNameData'];
    var musicImgsData = window.parent.window['musicImgsData'];
    ...
    function playPause(){
        if(audio.paused){
            ...
            Promise.resolve(audio.play()).catch(function(e){
    ...
    function updateCurrTime()
	{
        ...
        // window.parent.window['playProgress'] = Math.max(window.parent.window['playProgress'], playProgress);
		...
		{
            console.log("done");
            window.parent.window['playDone'] = true;
            playPauseBtn.attr('class','btn play-pause icon-jiediankaishi iconfont'); // 显示播放按钮
    ...
    function selectTrack(flag){
        ...
        musicImgs.find('.img').css({'background-size':'cover'})
